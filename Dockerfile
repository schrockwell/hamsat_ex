...
#   - https://hub.docker.com/_/debian?tab=tags&page=1&name=debian-trixie-20260202-slim - for the release image
#   - https://pkgs.org/ - resource for finding needed packages
#   - Ex: hexpm/elixir:1.16.0-erlang-26.2.1-debian-debian-trixie-20260202-slim
#
...
RUN apt-get update -y && \
    apt-get install -y libstdc++6 openssl locales ca-certificates wget \
    && apt-get clean && rm -f /var/lib/apt/lists/*_*
